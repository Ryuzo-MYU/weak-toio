...
- [1. ppm toio WBS 兼企画設計いろいろ書](#1-ppm-toio-wbs-兼企画設計いろいろ書)
  ...
  - [1.2. ソフトウェア開発](#12-ソフトウェア開発)
    ...
    - [1.2.2. センサー受取クラスの実装](#122-センサー受取クラスの実装)
      ...
      - [1.2.2.3. データ統合クラスの実装](#1223-データ統合クラスの実装)
      - [1.2.2.4. データの送信](#1224-データの送信)
    - [1.2.3. センサー評価クラスの実装](#123-センサー評価クラスの実装)
      - [1.2.3.1. データの受信と処理](#1231-データの受信と処理)
      - [1.2.3.2. 評価リストの作成](#1232-評価リストの作成)
    - [1.2.4. 行動決定クラスの実装](#124-行動決定クラスの実装)
      - [1.2.4.1. 評価データの分析](#1241-評価データの分析)
      - [1.2.4.2. 行動リストからの選択](#1242-行動リストからの選択)
    - [1.2.5. 命令送信クラスの実装](#125-命令送信クラスの実装)
      - [1.2.5.1. toio への命令送信](#1251-toio-への命令送信)
      - [1.2.5.2. モーションライブラリの使用](#1252-モーションライブラリの使用)
    - [1.2.6. インターフェースのデザイン](#126-インターフェースのデザイン)
      - [1.2.6.1. ユーザーインターフェースの設計](#1261-ユーザーインターフェースの設計)
      - [1.2.6.2. ログ表示機能の追加](#1262-ログ表示機能の追加)
...
#### 1.2.5.2. モーションライブラリの使用

### 1.2.6. インターフェースのデザイン

#### 1.2.6.1. ユーザーインターフェースの設計
