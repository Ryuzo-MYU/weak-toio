...
namespace Evaluation
{
	...
	{
		private IENV2Sensor env2Sensor;
		...
		public TemperatureEvaluate(IENV2Sensor env2, float _upperBound, float _lowerBound)
		{
		...
		{
			CurrentTemperature = env2Sensor.GetTemperature(); // SensorUnitから気温を取得
